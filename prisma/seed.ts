...
async function main() {
  ...
  const membersData: {
    ...
    },
    {
      ...
      bio: 'Bushra M manages design workflow, asset handoffs, and creative quality control for TEDxGCEM.',
    ...
    },
    {
      ...
      bio: 'Challa Himasree works directly with TEDx speakers to refine thesis statements and presentation flow.',
    ...
    },
    {
      ...
      bio: 'Vyshnavi D collaborates with domain experts across science, art, and technology for TEDxGCEM 2026.',
    ...
    },
    {
      ...
      bio: 'C Charan Kumar Reddy leads speaker onboarding, topic research, and presentation structure.',
    ...
    },
    {
      ...
      bio: 'Vinayaka leads partner outreach, financial sponsorship packages, and community grants.',
    ...
    },
    {
      ...
      bio: 'Shivaprasad Patil focuses on local business alliances, in-kind sponsorships, and media partners.',
